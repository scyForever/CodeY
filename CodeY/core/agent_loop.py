...
from ..storage.checkpoint import CHECKPOINT_NONE_STATUS, CHECKPOINT_PARTIAL_STALE_STATUS, CHECKPOINT_WORKSPACE_MISMATCH_STATUS
...
class AgentLoop:
    ...
    def run(self, user_message):
        ...
        route = agent.route_task(user_message)
        ...
        while tool_steps < agent.max_steps and attempts < max_attempts:
            ...
            if prompt_metadata.get("budget_reductions"):
                agent.compact_session_context(task_state.run_id)
